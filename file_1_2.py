...
def get_shop_list_by_dishes(dishes, person_quant):
    grocery_dict = {}  #Пустой словарь для хранения списка покупок
    for _dish in dishes:
        for ingredient in cook_book[_dish]:  #Выбор ингредиентов
            #Добавление ингредиетов с учетом количества персон
